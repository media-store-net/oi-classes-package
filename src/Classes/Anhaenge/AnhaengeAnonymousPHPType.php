...
namespace MediaStoreNet\OpenImmo\Classes\Anhaenge;

/**
 * Class representing AnhaengeAnonymousPHPType
 */
class AnhaengeAnonymousPHPType
{
     ...
     */
    public function addToAnhang(\MediaStoreNet\OpenImmo\Classes\Anhang $anhang)
    {
        $this->anhang[] = $anhang;
        return $this;
    }
     ...
     * @return bool
     */
    public function issetAnhang($index)
    {
        return isset($this->anhang[$index]);
    }
     ...
     * @return void
     */
    public function unsetAnhang($index)
    {
