...
namespace MediaStoreNet\OpenImmo\UserDefinedExtend;
...
class UserDefinedExtendAnonymousPHPType
{
    ...
    /**
     * @var \MediaStoreNet\OpenImmo\UserDefinedExtend\UserDefinedExtendAnonymousPHPType\FeldAnonymousPHPType[] $feld
     */
    private $feld = [
     ...
     */
    public function addToFeld(\MediaStoreNet\OpenImmo\UserDefinedExtend\UserDefinedExtendAnonymousPHPType\FeldAnonymousPHPType $feld)
    {
        $this->feld[] = $feld;
        return $this;
    }
