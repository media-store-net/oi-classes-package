...
namespace MediaStoreNet\OpenImmo\Bewertung;
...
class BewertungAnonymousPHPType
{
    ...
    /**
     * @var \MediaStoreNet\OpenImmo\Bewertung\BewertungAnonymousPHPType\FeldAnonymousPHPType[] $feld
     */
    private $feld = [
     ...
     */
    public function addToFeld(\MediaStoreNet\OpenImmo\Bewertung\BewertungAnonymousPHPType\FeldAnonymousPHPType $feld)
    {
        $this->feld[] = $feld;
        return $this;
    }
