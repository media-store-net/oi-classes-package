...
namespace MediaStoreNet\OpenImmo\ZustandAngaben;
...
class ZustandAngabenAnonymousPHPType
{
    ...
    /**
     * @var \MediaStoreNet\OpenImmo\Zustand $zustand
     */
    private $zustand = null;

    /**
     * @var \MediaStoreNet\OpenImmo\Alter $alter
     */
    private $alter = null;

    /**
     * @var \MediaStoreNet\OpenImmo\BebaubarNach $bebaubarNach
     */
    private $bebaubarNach = null;

    /**
     * @var \MediaStoreNet\OpenImmo\Erschliessung $erschliessung
     */
    private $erschliessung = null;

    /**
     * @var \MediaStoreNet\OpenImmo\ErschliessungUmfang $erschliessungUmfang
     */
    ...
    /**
     * @var \MediaStoreNet\OpenImmo\Energiepass[] $energiepass
     */
    private $energiepass = [
    ...
    /**
     * @var \MediaStoreNet\OpenImmo\Verkaufstatus $verkaufstatus
     */
     ...
     * Gets as zustand
     *
     * @return \MediaStoreNet\OpenImmo\Zustand
     */
     ...
     * Sets a new zustand
     *
     * @param \MediaStoreNet\OpenImmo\Zustand $zustand
     * @return self
     */
    public function setZustand(\MediaStoreNet\OpenImmo\Zustand $zustand)
    {
     ...
     * Gets as alter
     *
     * @return \MediaStoreNet\OpenImmo\Alter
     */
     ...
     * Sets a new alter
     *
     * @param \MediaStoreNet\OpenImmo\Alter $alter
     * @return self
     */
    public function setAlter(\MediaStoreNet\OpenImmo\Alter $alter)
    {
        $this->alter = $alter;
        return $this;
    }
     ...
     *
     * @return \MediaStoreNet\OpenImmo\BebaubarNach
     */
     ...
     *
     * @param \MediaStoreNet\OpenImmo\BebaubarNach $bebaubarNach
     * @return self
     */
    public function setBebaubarNach(\MediaStoreNet\OpenImmo\BebaubarNach $bebaubarNach)
    {
     ...
     *
     * @return \MediaStoreNet\OpenImmo\Erschliessung
     */
     ...
     *
     * @param \MediaStoreNet\OpenImmo\Erschliessung $erschliessung
     * @return self
     */
    public function setErschliessung(\MediaStoreNet\OpenImmo\Erschliessung $erschliessung)
    {
     ...
     *
     * @return \MediaStoreNet\OpenImmo\ErschliessungUmfang
     */
     ...
     *
     * @param \MediaStoreNet\OpenImmo\ErschliessungUmfang $erschliessungUmfang
     * @return self
     */
    public function setErschliessungUmfang(\MediaStoreNet\OpenImmo\ErschliessungUmfang $erschliessungUmfang)
    {
     ...
     *
     * @return self
     * @param \MediaStoreNet\OpenImmo\Energiepass $energiepass
     */
    public function addToEnergiepass(\MediaStoreNet\OpenImmo\Energiepass $energiepass)
    {
     ...
     * Gets as energiepass
     *
     * @return \MediaStoreNet\OpenImmo\Energiepass[]
     */
     ...
     *
     * @return \MediaStoreNet\OpenImmo\Verkaufstatus
     */
     ...
     *
     * @param \MediaStoreNet\OpenImmo\Verkaufstatus $verkaufstatus
     * @return self
     */
    public function setVerkaufstatus(\MediaStoreNet\OpenImmo\Verkaufstatus $verkaufstatus)
    {
