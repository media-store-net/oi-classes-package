...
namespace MediaStoreNet\OpenImmo\Anhang;
...
class AnhangAnonymousPHPType
{
    ...
    /**
     * @var \MediaStoreNet\OpenImmo\Check $check
     */
    private $check = null;
     ...
     * Gets as check
     *
     * @return \MediaStoreNet\OpenImmo\Check
     */
     ...
     * Sets a new check
     *
     * @param \MediaStoreNet\OpenImmo\Check $check
     * @return self
     */
    public function setCheck(\MediaStoreNet\OpenImmo\Check $check)
    {
        $this->check = $check;
        return $this;
    }
