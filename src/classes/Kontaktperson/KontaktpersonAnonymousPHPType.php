...
namespace MediaStoreNet\OpenImmo\Kontaktperson;
...
class KontaktpersonAnonymousPHPType
{
    ...
    /**
     * @var \MediaStoreNet\OpenImmo\Foto $foto
     */
    private $foto = null;
     ...
     * Gets as foto
     *
     * @return \MediaStoreNet\OpenImmo\Foto
     */
     ...
     * Sets a new foto
     *
     * @param \MediaStoreNet\OpenImmo\Foto $foto
     * @return self
     */
    public function setFoto(\MediaStoreNet\OpenImmo\Foto $foto)
    {
        $this->foto = $foto;
        return $this;
    }
